...
import { getClientAssets } from "../utils/manifest";
...
export default jsxRenderer(({ children }) => {
	...
	const ldJson = {
		...
		name: "ゆにるユニ",
		description:
			"2222年からやってきた未来のVirtual TechLead。IT技術のお話やプログラミングの配信を中心に、ゲーム遊んだり歌やピアノなどのやったことのない新しいスキルを身に着ける挑戦をしてみたり、色々と活動しています✨",
	...
	return (
		<html lang="ja">
			<head>
				...
				<script>{raw(scrollScript)}</script>
			</head>
			<body>{children}</body>
		</html>
	);
